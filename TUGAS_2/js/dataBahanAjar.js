const dummyData = {
    ...
    stok: [
      ...
      { kode: "MKDU4111", judul: "Pendidikan Kewarganegaraan", kategori: "MK Wajib", upbjj: "Padang", lokasiRak: "R4-D2", harga: 45000, qty: 0, safety: 50, catatanHTML: "<span style='color:red;'>Kosong total dari pusat</span>" }
    ],
    tracking: {
      "DO2026-001": {
        nim: "123456789", nama: "Rina Wulandari", status: "Dalam Perjalanan", ekspedisi: "JNE", tanggalKirim: "2026-05-10", paket: "PAKET-UT-001", total: 120000,
        perjalanan: [
          { waktu: "2026-05-10 10:12:20", keterangan: "Penerimaan di Loket: TANGSEL" },
          { waktu: "2026-05-10 14:07:56", keterangan: "Tiba di Hub: JAKSEL" }
        ]
      }
    }
  };